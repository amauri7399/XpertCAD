                ...
                (c.fn = c.prototype = {
                    ...
                    position: function() {
                        ...
                        return (
                            ...
                            a.style && ((e.top += parseFloat(a.style.borderTopWidth) || 0), (e.left += parseFloat(a.style.borderLeftWidth) || 0)), { top: d.top - e.top, left: d.left - e.left }
                        );
                    },
                });
                var d = {};
        ...
        return this.each(function() {
            function b() {
                ...
                i.velocity("stop", !0),
                    ...
                    a("#materialbox-overlay").velocity({ opacity: 0 }, {
                        duration: h,
                        queue: !1,
                        easing: "easeOutQuad",
                        complete: function() {
                ...
                i.wrap(j),
                    i.on("click", function() {
                        ...
                        s > t ? ((r = m / l), (u = 0.9 * j), (v = 0.9 * j * r)) : ((r = l / m), (u = 0.9 * k * r), (v = 0.9 * k)),
                            ...
                            i.velocity({ "max-width": u, width: l }, {
                                duration: 0,
                                queue: !1,
                                complete: function() {
...
(Materialize.toast = function(a, b, c, d) {
    function e(a) {
        ...
        b.appendChild(a): a instanceof jQuery ?
            b.appendChild(a[0]) :
            (b.innerHTML = a);
                        ...
                        .bind("panend", function(a) {
                            "touch" === a.gesture.pointerType &&
                                (($curr_slide = i.find(".active")),
                                    ...
                                    m ?
                                    (d(curr_index + 1),
                                        $curr_slide.velocity({ translateX: -1 * h.innerWidth() }, {
                                            duration: 300,
                                            queue: !1,
                                            easing: "easeOutQuad",
                                            complete: function() {
                                    ...
                                    n &&
                                    (d(curr_index - 1),
                                        $curr_slide.velocity({ translateX: h.innerWidth() }, {
                                            duration: 300,
                                            queue: !1,
                                            easing: "easeOutQuad",
                                            complete: function() {
                ...
                .bind("panend", function(d) {
                    if ((Math.abs(d.gesture.deltaX) < a(this).innerWidth() / 2 && ((c = !1), (b = !1)), "touch" === d.gesture.pointerType)) {
                        ...
                        if (b || c) {
                            ...
                            e.velocity({ translateX: f }, {
                                duration: 100,
                                queue: !1,
                                easing: "easeOutQuad",
                                complete: function() {
                                    e.css("border", "none"),
                                        e.velocity({ height: 0, padding: 0 }, {
                                            duration: 200,
                                            queue: !1,
                                            easing: "easeOutQuad",
                                            complete: function() {
            ...
            y.$root
                ...
                .on("click", "[data-pick], [data-nav], [data-clear], [data-close]", function() {
                    var b = a(this),
                        ...
                        e = h();
                    (e = e && (e.type || e.href)),
                    (d || (e && !a.contains(y.$root[0], e))) && y.$root.eq(0).focus(), !d && c.nav ? y.set("highlight", y.component.item.highlight, { nav: c.nav }) : !d && "pick" in c ? y.set("select", c.pick) : c.clear ? y.clear().close(!0) : c.close && y.close(!0);
                }),
                e(y.$root[0], "hidden", !0);
        }
...
(function(a) {
    ...
    (c.prototype.create = function(a, c, d) {
        ...
        return (
            ...
            (c = f.isInteger(c) || f.isDate(c) ? g.normalize(new Date(c), d) : g.now(a, c, d)), { year: e || c.getFullYear(), month: e || c.getMonth(), date: e || c.getDate(), day: e || c.getDay(), obj: e || c, pick: e || c.getTime() }
        );
    }),
    (c.prototype.createRange = function(a, c) {
        ...
        return (
            f.isInteger(a) || (a = e(a)),
            f.isInteger(c) || (c = e(c)),
            f.isInteger(a) && b.isPlainObject(c) ? (a = [c.year, c.month, c.date + a]) : f.isInteger(c) && b.isPlainObject(a) && (c = [a.year, a.month, a.date + c]), { from: e(a), to: e(c) }
        );
    }),
            ...
            return this.each(function(c) {
                ...
                function p(a) {
                    if (v)
                        return (
                            ...
                            J && (a.preventDefault(), a.stopPropagation()), !1
                        );
                }
                var q,
                    r,
                ...
                return (
                    ...
                    (O.addClass("initialized"),
                        ...
                        P && O.append(M),
                        (x = q.length),
                        (F = "transform"), ["webkit", "Moz", "O", "ms"].every(function(a) {
                            var b = a + "Transform";
